...
function quizQuestion(dataQuiz, i, point) {
    ...
    document.getElementById('answer2').innerText = dataQuiz[i].incorrect_answers[0]
    document.getElementById('answer3').innerText = dataQuiz[i].incorrect_answers[1]
    document.getElementById('answer4').innerText = dataQuiz[i].incorrect_answers[2]
}